...
\begin{frame}
	...
	\framesubtitle{ Tasks like  Selecting a Hotel and Booking a Hotel.}
		\begin{center}
 			\includegraphics[ scale=0.95]{Scenario1}
 					\end{center} 
...
\begin{frame}
	...
	\framesubtitle{Interaction with a Payment API}
		\begin{center}
 			\includegraphics[ scale=0.35]{Scenario2}
 					\end{center} 
...
\begin{frame}
	...
	\framesubtitle{A publicly exposed application which is accessed by a Web API }
		\begin{center}
 			\includegraphics[ scale=0.35]{Scenario3}
 					\end{center} 
...
\begin{frame}
	\frametitle{Test Boundaries}
	\framesubtitle{Test boundaries for the example}

		\begin{center}
 			\only<1>{\includegraphics[ scale=0.1]{TestBoundaries1}\\}
 			\only<2>{\includegraphics[ scale=0.1]{TestBoundaries2}\\}
\only<3>{\includegraphics[ scale=0.1]{TestBoundaries3}\\}
\only<4>{\includegraphics[ scale=0.1]{TestBoundaries}\\}
