...
\begin{frame}
	...
	\begin{itemize}
		\item RAD is a prerequisite for microservices. \cite{fowler_micr_prer}
...
\begin{column}{.49\textwidth}
	\begin{figure}
		\begin{center}
 			\only<1>{\includegraphics[ scale=0.5]{blue_green2}\\}
 			\only<2>{\includegraphics[ scale=0.5]{canary2}}\par
		\end{center}
	\end{figure}
\end{column}
\end{columns}
...
\begin{column}{.25\textwidth}
	\begin{figure}
		\begin{center}
 			\includegraphics[ scale=0.2]{el_stack_logo}
		\end{center}
	\end{figure}
\end{column}
\end{columns}
